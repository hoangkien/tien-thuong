...
class Admin::CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_category" do
    assert_difference('Admin::Category.count') do
      post admin_categories_url, params: { admin_category: { alias_name: @admin_category.alias_name, name: @admin_category.name } }
    end
  ...
  test "should update admin_category" do
    patch admin_category_url(@admin_category), params: { admin_category: { alias_name: @admin_category.alias_name, name: @admin_category.name } }
