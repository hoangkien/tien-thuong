...
class Admin::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post admin_products_url, params: { admin_product: { alias_name: @admin_product.alias_name, content: @admin_product.content, name: @admin_product.name, new_price: @admin_product.new_price, price: @admin_product.price } }
    end
  ...
  test "should update admin_product" do
    patch admin_product_url(@admin_product), params: { admin_product: { alias_name: @admin_product.alias_name, content: @admin_product.content, name: @admin_product.name, new_price: @admin_product.new_price, price: @admin_product.price } }
